/**
 * FEATURE FLAGS
 * Set to 'true' to enable these sections on the live site.
 */

export const FEATURES = {
  SHOW_DIGITAL_LIBRARY: false, // Hide the Digital Library on the Shop page
  SHOW_UPSELLS: false,         // Hide Sketch Pens/Sibling Bundle in OrderModal
